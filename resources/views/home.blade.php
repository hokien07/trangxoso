        ...
        <div class="box">
            ...
            <table class="table table-striped table-bordered" id="table-kiet-qua-mien-bac">
                <thead>
                    <tr>
                        <th>#</th>
                        <th scope="col" class="tinh-mien-nam-mo-thuong">{{$mien_nam_first->ten_tinh}} <br/> {{$mien_nam_first->ngay_mo_thuong}}</th>
                        <th scope="col" class="tinh-mien-nam-mo-thuong">{{$mien_nam_second->ten_tinh}} <br/> {{$mien_nam_second->ngay_mo_thuong}}</th>
                        <th scope="col" class="tinh-mien-nam-mo-thuong">{{$mien_nam_there->ten_tinh}} <br/> {{$mien_nam_there->ngay_mo_thuong}}</th>
                    </tr>
                </thead>
                <tbody>
                <tr>
