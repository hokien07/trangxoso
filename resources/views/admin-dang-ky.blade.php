...
@section('content')
    ...
    <div class="container">
        <form class="form-horizontal" action="{{route('dang-ky')}}" method="POST">
            <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />

            <fieldset>
                <div id="legend">
                    <legend class="">Đăng ký tài khoản</legend>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="control-group">
                            <!-- Username -->
                            <label class="control-label" for="username">tên đăng nhập | Email</label>
                            <div class="controls">
                                <input type="text" id="username" name="username" placeholder="" class="input-xlarge">
                                <p class="help-block">Tên đăng nhập hoặc email</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <p class="help-block">Nhập Email của bạn.</p>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" id="password_confirm" name="password_confirm" placeholder=""
                                       class="input-xlarge">
                                <p class="help-block">Nhập lại mật khẩu của bạn.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
